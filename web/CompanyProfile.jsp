<%-- 
    ...
    Created on : Mar 13, 2019, 11:01:45 AM
    Author     : Akash
--%>
...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="resources/Company/Dashboard/assets/img/apple-icon.png">
  <link rel="icon" type="image/png" href="resources/Company/Dashboard/assets/img/favicon.png">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 px-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Established Date" value="michael23">
                      </div>
                    </div>
              ...
              <div class="card-body ">
                <p class="card-text">
                  <div class="author">
                    ...
                    <a href="#">
                      <img class="avatar" src="resources/Company/Dashboard/assets/img/anime6.png" alt="...">
